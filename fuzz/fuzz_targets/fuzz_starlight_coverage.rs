//! Generate coverage for the `fuzz_starlight` target.
//! Warning: this file has been automatically generated using the `run_coverage.py` script
//! from the contents of `fuzz_targets/coverage.rs` and `fuzz_targets/fuzz_starlight.rs`.

#![allow(clippy::absurd_extreme_comparisons)]
#![allow(clippy::not_unsafe_ptr_arg_deref)]
const FUZZ_TARGET_NAME: &str = "fuzz_starlight";
